...
def tab3_layout():
    ...
    col_1 = sg.Column([
        ...
        [sg.Image(filename="", key="yolo_image")]
    ...
    col_3 = sg.Column([
        [sg.Multiline(size=(40,40), disabled=True, background_color="black",font='courier 8', key='-yolo_ML-')]
    ], vertical_alignment='top')
...
def main():
    ...
    window["network"].update("../cfg")
    window["image"].update("../data/img/FLIR_09312.jpg")
    ...
    while True:
        ...
        window
        print(window["yolo_image"].get_size())
        ...
        if event == "run":
            window['-yolo_ML-'].print("[INFO] Loading YOLO from disk... ", end="")
            
            # sg.popup_auto_close("Loading YOLO from disk... please wait")
            ...
            window['-yolo_ML-'].print("done.")
            # print("[INFO] Loading YOLO from disk... done.", end="\r")            
